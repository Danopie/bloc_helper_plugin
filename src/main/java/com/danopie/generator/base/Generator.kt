...
abstract class Generator(private val blocName: String,
    ...
    private val TEMPLATE_PATH = "path"
...
//            val resource = "/templates/$templateFolder/$templateName.dart.template"
            ...
            templateString = CharStreams.toString(InputStreamReader(resourceAsStream, Charsets.UTF_8) as Readable)
        } catch (e: Exception) {
    ...
    fun generate(path:String): String {
        println(path)
        templateValues[TEMPLATE_PATH] = path
